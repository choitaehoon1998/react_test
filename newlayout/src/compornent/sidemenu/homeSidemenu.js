...
const[item3, setItem3]=useState(0);
  ...
  return (
      ...
      <ul className={item1 === 1 ? "listGroup" : "listGroup-hidden"}>
        <li>
          <Link to="" className="sideMenuText">기본 정보 설정</Link>
        </li>
        <li>
          <Link to="" className="sideMenuText">약관/개인정보처리방침</Link>
        </li>
        <li>
          <Link to="" className="sideMenuText">이용/탈퇴 안내</Link>
        </li>
        <li>
          <Link to="" className="sideMenuText">금액/단위 기준 설정</Link>
        </li>
        <li>
          <Link to="" className="sideMenuText">파일 저장소 관리</Link>
        </li>
        <li>
          <Link to="" className="sideMenuText">코드 관리</Link>
        </li>
        <li>
          <Link to="" className="sideMenuText">외부 스크립트 관리</Link>
        </li>
      </ul>
      ...
      <ul className={item2 === 1 ? "listGroup" : "listGroup-hidden"}>
        <li>
          <Link to="" className="sideMenuText">운영자 관리</Link>
        </li>
        <li>
          <Link to="" className="sideMenuText">운영자 권한 설정</Link>
        </li>
        <li>
          <Link to="" className="sideMenuText">운영 보안 설정</Link>
        </li>
        <li>
          <Link to="" className="sideMenuText">쇼핑몰 이용 설정</Link>
        </li>
        <li>
          <Link to="" className="sideMenuText">비밀번호 찾기 설정</Link>
        </li>
        <li>
          <Link to="" className="sideMenuText">비밀번호 변경안내 설정</Link>
        </li>
      ...
      <ul className={item3 === 1 ? "listGroup" : "listGroup-hidden"}>
        <li>
          <Link to="" className="sideMenuText">상품 기본 설정</Link>
        </li>
        <li>
          <Link to="" className="sideMenuText">상품 이미지 사이즈 설정</Link>
        </li>
        <li>
          <Link to="" className="sideMenuText">상품 상세 이용안내 관리</Link>
        </li>
        <li>
